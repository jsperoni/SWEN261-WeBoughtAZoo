...
> 
![Static Code Analysis screenshot 1](screenshot 1.png)
This issue is resulting form the code snippet being commented out. I don’t see this issue as a major issue as it doesn’t interfere with the functionality of the code and it allows the developers to change back to printing the log messages if they needed. I feel like we should ignore the error and lower the severity of the issue. 

![Static Code Analysis screenshot 2](screenshot 2.png)
This is an issue as there is no assertion for the test case. This test case is pointless as it doesn’t test anything and should be removed. I am unsure why it is in the code.

![Static Code Analysis screenshot 3](screenshot 3.png)
This issue occurred because we are wrapping a primitive type instead of explicitly defining it. We should remove the explicit boolean definition as it is unnecessary. 
